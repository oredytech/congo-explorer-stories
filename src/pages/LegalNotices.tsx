          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8 text-congo-brown/80">
              ...
              <section>
                ...
                <p>Tous les contenus présents sur ce site (textes, images, vidéos, sons, logos, documents à télécharger, etc.) sont, sauf mention contraire, la propriété exclusive de VisiteCongo. Toute reproduction ou utilisation sans autorisation écrite est interdite.</p>
              </section>
              ...
              <section>
                ...
                <p>Le site peut utiliser des cookies pour améliorer la navigation et analyser l'audience. L'utilisateur peut refuser l'utilisation des cookies en configurant son navigateur.</p>
              </section>
              ...
              <section>
                ...
                <p>VisiteCongo ne peut être tenu responsable des erreurs, interruptions ou bugs du site, ni de l'usage qui pourrait en être fait par des tiers. Les liens externes sont proposés à titre informatif, sans engagement sur leur contenu.</p>
              </section>

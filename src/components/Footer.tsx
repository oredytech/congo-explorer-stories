...
const Footer = () => {
  ...
  return (
    <footer className="bg-congo-brown text-congo-beige border-t border-congo-brown/20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <Link 
              to="/assistance" 
              className="inline-flex items-center space-x-2 text-sm text-congo-green hover:text-congo-green/80 transition-colors"
            >
